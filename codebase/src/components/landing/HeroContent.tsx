// Updated text to reflect Live Aid app marketing
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between h-[500px] pt-8 px-4 sm:px-6 lg:px-8 gap-8">
      ...
      <div className="lg:w-1/2 w-full max-w-4xl mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
        ...
        >
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary via-accent to-[var(--chart-5)] animate-pulse opacity-50"></div>
          <div className="relative bg-white dark:bg-gray-900 rounded-full py-2 px-4 text-center">
            <p className="text-xs font-medium">
              This project was cooked on{" "}
              <a
        ...
        >
          Live Aid uses data analytics and machine learning to estimate economic
          losses in conflict regions, helping NGOs and donors allocate resources
      ...
      >
        ...
        <motion.div
          ...
          className="absolute bottom-4 left-4 max-w-[200px] bg-card/80 dark:bg-card/80 backdrop-blur-sm p-3 rounded-lg shadow-md translate-y-4"
        >
          ...
          <p className="text-sm font-medium">
            "Transformed how we allocate aid resources."
          </p>
          <p className="text-xs mt-1 text-muted-foreground">
            - Sarah K., NGO Director
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute bottom-4 right-4 max-w-[200px] bg-card/80 dark:bg-card/80 backdrop-blur-sm p-3 rounded-lg shadow-md -translate-y-4"
        >
          <div className="flex mb-1">
            {[...Array(5)].map((_, i) => (
              <svg
          ...
          <p className="text-sm font-medium">
            "The data insights have been invaluable for our work."
          </p>
          <p className="text-xs mt-1 text-muted-foreground">
            - Michael T., Humanitarian Aid
          </p>
        </motion.div>
      </motion.div>
    </div>
